...
<!-- Mirrored from kamleshyadav.in/html/cycling/version-1/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 03:05:51 GMT -->
<head>
                    ...
                    <div class="cy_menu">
                        <nav>
                            <ul>
                                ...
                                <li class="dropdown"><a href="javascript:;" class="active">event</a>
                                    <ul class="sub-menu">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cy_event_box">
                        <div class="cy_event_img">
                            <img src="images/event/event7.jpg" alt="event" class="img-fluid" />
                            <div class="cy_event_detail">
                                <div class="cy_event_time">
                                    <ul>
                                        <li><i><img src="images/svg/clock.svg" alt="event time"></i> 12:00 PM to 5:00PM</li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cy_event_box">
                        <div class="cy_event_img">
                            <img src="images/event/event8.jpg" alt="event" class="img-fluid" />
                            <div class="cy_event_detail">
                                <div class="cy_event_time">
                                    <ul>
                                        <li><i><img src="images/svg/clock.svg" alt="event time"></i> 12:00 PM to 5:00PM</li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cy_event_box">
                        <div class="cy_event_img">
                            <img src="images/event/event9.jpg" alt="event" class="img-fluid" />
                            <div class="cy_event_detail">
                                <div class="cy_event_time">
                                    <ul>
                                        <li><i><img src="images/svg/clock.svg" alt="event time"></i> 12:00 PM to 5:00PM</li>
...
<!-- Mirrored from kamleshyadav.in/html/cycling/version-1/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 03:05:52 GMT -->
</html>