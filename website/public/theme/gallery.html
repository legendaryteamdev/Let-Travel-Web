...
<!-- Mirrored from kamleshyadav.in/html/cycling/version-1/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 03:05:56 GMT -->
<head>
...
<body>
    ...
    <div class="cy_gallery_wrapper cy_section_padding padder_bottom100">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="cy_gal_img">
                                <img src="images/gallery/gal_img7.jpg" alt="gallery" class="img-fluid" />
                                <div class="img_gal_ovrly"></div>
                                <div class="gal_buttons">
                                    <a href="images/gallery/gal_big7.jpg" class="fa fa-search"></a>
                                    <a href="#" class="fa fa-link"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <div class="cy_gal_img">
                                <img src="images/gallery/gal_img8.jpg" alt="gallery" class="img-fluid" />
                                <div class="img_gal_ovrly"></div>
                                <div class="gal_buttons">
                                    <a href="images/gallery/gal_big8.jpg" class="fa fa-search"></a>
                                    <a href="#" class="fa fa-link"></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="cy_gal_img">
                                <img src="images/gallery/gal_img9.jpg" alt="gallery" class="img-fluid" />
                                <div class="img_gal_ovrly"></div>
                                <div class="gal_buttons">
                                    <a href="images/gallery/gal_big9.jpg" class="fa fa-search"></a>
                                    <a href="#" class="fa fa-link"></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="cy_gal_img">
                        <img src="images/gallery/gal_img10.jpg" alt="gallery" class="img-fluid" />
                        <div class="img_gal_ovrly"></div>
                        <div class="gal_buttons">
                            <a href="images/gallery/gal_big10.jpg" class="fa fa-search"></a>
                            <a href="#" class="fa fa-link"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="cy_gal_img">
                        <img src="images/gallery/gal_img11.jpg" alt="gallery" class="img-fluid" />
                        <div class="img_gal_ovrly"></div>
                        <div class="gal_buttons">
                            <a href="images/gallery/gal_big11.jpg" class="fa fa-search"></a>
                            <a href="#" class="fa fa-link"></a>
                        </div>
                    </div>
                    <div class="cy_gal_img">
                        <img src="images/gallery/gal_img12.jpg" alt="gallery" class="img-fluid" />
                        <div class="img_gal_ovrly"></div>
                        <div class="gal_buttons">
                            <a href="images/gallery/gal_big12.jpg" class="fa fa-search"></a>
                            <a href="#" class="fa fa-link"></a>
                        </div>
                    </div> 
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="cy_gal_view">
                        <a href="#" class="cy_button">view more</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="cy_recent_post">
                        <div class="cy_post_img">
                            <a href="#"><img src="images/footer/post1.jpg" alt="post"/></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        ...
                        <div class="cy_foo_gallery">
                            <ul>
                                <li><a href="#"><img src="images/footer/gal1.jpg" alt="flicker gallery"></a></li>
                                <li><a href="#"><img src="images/footer/gal2.jpg" alt="flicker gallery"></a></li>
                                <li><a href="#"><img src="images/footer/gal3.jpg" alt="flicker gallery"></a></li>
                                <li><a href="#"><img src="images/footer/gal4.jpg" alt="flicker gallery"></a></li>
                                <li><a href="#"><img src="images/footer/gal5.jpg" alt="flicker gallery"></a></li>
                                <li><a href="#"><img src="images/footer/gal6.jpg" alt="flicker gallery"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>  
    ...
    <div class="cy_btm_footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <P>Copyright &copy; 2018, <a href="#">Cycling</a>. All Rights Reserved.</P>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from kamleshyadav.in/html/cycling/version-1/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 03:05:59 GMT -->
</html>