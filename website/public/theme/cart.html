...
<!-- Mirrored from kamleshyadav.in/html/cycling/version-1/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 03:05:49 GMT -->
<head>
                    ...
                    <div class="cy_menu">
                        <nav>
                            <ul>
                                ...
                                <li class="dropdown"><a href="javascript:;" class="active">pages</a>
                                    <ul class="sub-menu">
                        ...
                        <table class="shop_table shop_table_responsive cart table-stripped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="product-name">Road Bicycles</td>
                                    <td class="product-price">$2500</td>
                                    <td class="product-remove"><a href="#"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="product-thumbnail"><a href="#"><img src="images/cart/2.jpg" alt="cart thumbnail" class="img-fluid"></a></td>
                                    <td class="product-name">Road Bicycles</td>
                                    <td class="product-price">$2500</td>
                                    <td class="product-remove"><a href="#"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                </tr>
                                <tr>
                                    <td class="product-thumbnail"><a href="#"><img src="images/cart/3.jpg" alt="cart thumbnail" class="img-fluid"></a></td>
                                    <td class="product-name">Road Bicycles</td>
                                    <td class="product-price">$2500</td>
                                    <td class="product-remove"><a href="#"><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                </tr>
                    ...
                    <div class="cy_cart_sidebar">
                        ...
                        <div class="cart-collaterals">
                            ...
                            <div class="wc-proceed-to-checkout">
                                <a href="checkout.html" class="cy_button">Proceed To Checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from kamleshyadav.in/html/cycling/version-1/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Apr 2019 03:05:50 GMT -->
</html>